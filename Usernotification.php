...
$ID = $row["ID"];
  ...
  //Fetch the lost item
//   $UserFetch = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM lostposts WHERE ItemID = '$ID'"));
    ...
    <section class="flex bg-slate-100" style="font-family: 'Montserrat', sans-serif;">
        ...
        <div class=" mt-5 ml-5 w-full h-full mr-10">
            ...
            <div class="w-full flex justify-center ">
                ...
                <div>
                       <h1 class="uppercase font-thin text-sm ">TrackNback</h1>
    
                       <h1 class="uppercase font-base text-2xl">Notifications</h1>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
            ...
            <div class="mt-10  h-[52rem] overflow-scroll flex">
                ...
                <div class="w-full h-full">
                    ...
                    <div class="w-full h-fit p-5 bg-white grid mt-10 space-y-5">
                        <h1>Your Notifications</h1> 


                        <?php
                   $query1 = "SELECT * FROM notifications WHERE OwnerID = '$ID'";
                   $result = $conn->query($query1);
                    ...
                    while($postFetch = $result->fetch_assoc()){
                        ...
                        ?>
                            ...
                            <div class="w-full h-fit flex space-x-2 items-center">
                            <div>
                            ...
                            <h1 class="border border-orange-500 rounded-xl p-5 "><?php echo $postFetch["NotificationDesc"];?></h1>
                        </div>
                ...
                <div class="w-1/2 ml-5 flex items-center">
                    <div class="w-full bg-white shadow-md items-center  rounded-xl">
                        ...
                        <div class="w-full flex justify-center">
                            <img src="imgs/darain.jpg" alt="" class="aspect-square  object-cover mt-20 w-56 rounded-full">
                        </div>
