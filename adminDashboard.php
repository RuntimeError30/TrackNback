...
if(isset($_POST["addCat"])){
    ...
    $InsertCat = mysqli_query($conn, "INSERT INTO category(NewCategory, CategoryID) VALUES ('$Category','$catID')");
...
<body>
    <section class="flex bg-slate-950 text-white" style="font-family: 'Montserrat', sans-serif;">
        ...
        <div id="sidebar" class="grid items-center justify-between bg-black h-screen text-white " style="width:40px">
            ...
            <div class="" id="mainDIV" style=" visibility: hidden;">
                ...
                <div class="flex flex-col justify-start ml-8 mt-60" id="maintainSide">
                    ...
                    <div class="flex items-center mb-2">
                        <a href="adminSettings.php" class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class=" mb-2 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          ...
                          <ul class="p-3 hidden bg-stone-800 rounded-xl" id="dropOptions">
                            ...
                            <li>
                                <a href="postApproveList.php" class="flex items-center space-x-1">
        ...
        <div class="  ml-5 w-full h-full mr-10  h-screen overflow-y-scroll">
            ...
            <div class="flex space-x-5 w-full mt-5">

                <form action="" class="w-full flex flex-col space-y-7 items-center" method="post">
                    <div class="border border-slate-800 shadow-xl p-5 w-full rounded-xl bg-slate-900 shadow-xl">
                    
                        <h1 class="text-xs uppercase">Edit About Us</h1>
                        <textarea name="AboutBox" id="" class="w-full resize-none rounded-xl mt-2 h-56 text-whiteoutline-none bg-transparent border border-orange-500 "></textarea>
                        <button type="submit" name="aboutUs" class="bg-black p-3 rounded-xl w-full mt-2 hover:text-orange-500 transition-all ease-in">Save Changes</button>
                    </div>

                    <div class="border border-slate-800 shadow-xl p-5 w-full rounded-xl bg-slate-900 shadow-xl h-[22rem] overflow-scroll">
                    
                        <h1 class="text-xs uppercase">Add Admin to the TrackNBack Portal </h1>

                        <div class="space-y-6">
                            <input type="text" name="AdminName" id="" class="w-full resize-none  mt-2  text-white outline-none bg-transparent border-b border-orange-500 " placeholder="Name">

                            <input type="text" name="AdminMobile" id="" class="w-full resize-none  mt-2  text-white outline-none bg-transparent border-b border-orange-500 " placeholder="Mobile">


                            <select name="Role" id="" class="w-full resize-none  mt-2  text-white outline-none bg-transparent border-b border-orange-500 ">
                                <option value="Aditional Admin">Select Admin Role</option>
                                <option value="Aditional Admin">Aditional Admin</option>
                            </select>

                            <input type="text" name="AdminEmail" id="" class="w-full resize-none  mt-2  text-white outline-none bg-transparent border-b border-orange-500 " placeholder="Email">


                            <input type="Passwordtext" name="AdminPassword" id="" class="w-full resize-none  mt-2  text-white outline-none bg-transparent border-b border-orange-500 " placeholder="Password">
                        </div>
                        ...
                        <button type="submit" name="AdminChange" class="bg-black p-3 rounded-xl w-full mt-2 hover:text-orange-500 transition-all ease-in">Register New Admin</button>
                    </div>
                ...
                <div class="w-full h-fit border border-slate-800 shadow-xl p-5  rounded-xl bg-slate-900 shadow-xl">
                    <h1>Add an Lost Category</h1>



                    <form action="" method="POST" class="mt-5">
                    <label for="" class="text-xs">Type the Name of Category</label>
                    <input type="text" name="Category" id="" class="w-full h-10 mt-2  text-white outline-none bg-transparent border rounded-xl border-orange-500 " >

                    <button type="submit" name="addCat" class="bg-black p-3 rounded-xl w-full mt-2 hover:text-orange-500 transition-all ease-in">Add a New Category</button>
                    </form>
                   ...
                   $result = $conn->query($query1);
                    ...
                    while($postFetch = $result->fetch_assoc()){
                        ?>
                            ...
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-lime-500" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div>
                                <h1><?php echo $postFetch["Name"]?></h1>
                                <h1 class="text-xs"><?php echo $postFetch["Position"]?></h1>
                                <h1 class="text-xs"><?php echo $postFetch["Mobile"]?></h1>
                                <h1 class="text-xs"><?php echo $postFetch["Email"]?></h1>
                            </div>
