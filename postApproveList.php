...
<body>
    ...
    <thead class=" w-full">
        <tr>
            ...
            <th class="border px-4 py-2">Item Category</th>
            <th class="border px-4 py-2">Item Photo</th>
            <th class="border px-4 py-2">Item Description</th>

        


            <th class="border px-4 py-2">Item Status</th>
            <th class="border px-4 py-2">Approve Status</th>
        </tr>
    </thead>

    <tbody class=" w-full id="myTable">
        <?php
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
            <tr class="w-full">
                <td class="border px-4 py-2"><?php echo $row['OwnerName'] ?> </td>
                <td class="border px-4 py-2"><?php echo $row['OwnerID'] ?> </td>
                <td class="border px-4 py-2"><?php echo $row['OwnerMobile'] ?> </td>
                <td class="border px-4 py-2"><?php echo $row['OwnerEmail'] ?> </td>

                <td class="border px-4 py-2"><?php echo $row['ItemCategory'] ?> </td>
                <td class="border px-4 py-2"><img src="imgs/<?php echo $row['itemImage'] ?>" class="aspect-square object-cover w-32" alt=""> </td>
                <td class="border px-4 py-2"><?php echo $row['Description'] ?> </td>

                <td class="border px-4 py-2"><?php echo $row['itemStatus'] ?> </td>
                <td class="border px-4 py-2"><?php echo $row['approveStatus'] ?> </td>
